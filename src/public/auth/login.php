...
<div class="flex justify-center">
    <div class="max-w-md w-full space-y-8">
        ...
        <form class="space-y-4" method="post" action="/src/public/auth/login.php">
            ...
            <button type="submit" name="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</button>
        </form>
