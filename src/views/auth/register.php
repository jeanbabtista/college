<div class="flex justify-center">
    <div class="max-w-md w-full space-y-8">
        ...
        <form class="space-y-4" method="post" action="<?php echo getQuery('auth', 'register') ?>">
            <div class="mb-4">
            ...
            <div class="mb-6">
                <label for="repeat_password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">
