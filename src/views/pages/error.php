<!--
    ...
    $errorMessage
-->
<?php list('errorMessage' => $errorMessage) = get_defined_vars() ?>

<div id="toast-danger"
     class="flex items-center p-4 mb-4 w-full text-gray-500 bg-white rounded-lg shadow
    ...
    <div class="inline-flex flex-shrink-0 justify-center items-center w-8 h-8 text-red-500 bg-red-100 rounded-lg
        ...
        <svg class="w-5 h-5"
            ...
            <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414
                10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1
                0 010-1.414z" clip-rule="evenodd">
            </path>
        </svg>
    </div>

    <div class="ml-3 text-sm font-normal"><?php echo $errorMessage ?></div>
